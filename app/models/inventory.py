...
class Resource:
    ...
    def __init__(self, name, manufacturer, total, allocated):
        ...
        validate_integer('allocated', allocated, 0, total, custom_max_msg='Allocated inventory cannot exceed total '
                                                                          'inventory.')
    ...
    def claim(self, n):
        ...
        """
        validate_integer('n', n, 1, self.available, custom_max_msg='Cannot retire more than allocated')
        self._allocated += n
    ...
    def free_up(self, n):
        ...
        """
        validate_integer('n', n, 1, self.allocated, custom_max_msg='Cannot return more than allocated')
        self._allocated -= n
    ...
    def died(self, n):
        ...
        """
        validate_integer('n', n, 1, self.allocated, custom_max_msg='Cannot retire more than allocated.')
        self._total -= n
        self._allocated -= n
...
class HDD(Storage):
    ...
    def __init__(self, name, manufacturer, total, allocated, capacity_gb, size, rpm):
        ...
        if size not in allowed_sizes:
            raise ValueError(f'Invalid HDD size.Must be one of {", ".join(allowed_sizes)}')
