...
def validate_integer(
        arg_name, arg_value, min_value=None, max_value=None, custom_min_msg=None, custom_max_msg=None
):
    """ Validates the "arg_value" is an integer, and optionally falls within specific bounds.
